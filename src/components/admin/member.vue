  ...
  <div class="member" v-if="enteringMember">
    <ul>
      ...
      <li v-for="member in members">
        아이디: <span>{{member.userid}}</span><br> 이름: <span>{{member.username}}</span><br> 학번 : <span>{{member.studentcode}}</span><br> 점수 : <span>{{member.score}}</span><br>
...
<style src="../../assets/css/member.css" scoped>
